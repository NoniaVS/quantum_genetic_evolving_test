...
import random
import scipy
from .tools import function_to_minimize
        ...
        for generation in range(n_generations):
            ...
            for i in range(len(self.__population)):
                ...
                if r > mutation_probability:
                    ...
                    mutated_dna = self.__mutator.mutation_add_gate(mutated_dna, num_wires)
                    mutated_dna = self.__mutator.mutation_del_gate(mutated_dna)
